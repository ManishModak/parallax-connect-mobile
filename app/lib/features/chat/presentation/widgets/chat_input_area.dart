                      ...
                      return Container(
                        ...
                        child: IconButton(
                          tooltip: widget.isLoading
                              ? 'Sending...'
                              : (isEditing
                                  ? 'Update message ${Theme.of(context).platform == TargetPlatform.macOS || Theme.of(context).platform == TargetPlatform.iOS ? '(Cmd+Enter)' : '(Ctrl+Enter)'}'
                                  : 'Send message ${Theme.of(context).platform == TargetPlatform.macOS || Theme.of(context).platform == TargetPlatform.iOS ? '(Cmd+Enter)' : '(Ctrl+Enter)'}'),
