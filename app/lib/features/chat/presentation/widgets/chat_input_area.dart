                      ...
                      return Container(
                        ...
                        child: IconButton(
                          tooltip: widget.isLoading
                              ? 'Sending...'
                              : (isEditing
                                  ? 'Update message (${Theme.of(context).platform == TargetPlatform.macOS ? "Cmd" : "Ctrl"}+Enter)'
                                  : 'Send message (${Theme.of(context).platform == TargetPlatform.macOS ? "Cmd" : "Ctrl"}+Enter)'),
