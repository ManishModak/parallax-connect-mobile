...
def _clean_element_noise(element):
    """
    Remove noise tags and classes from a specific element subtree.
    """
    ...
    elements_to_remove = []
    # Optimization: Use find_all with class_ to avoid iterating all elements
...
def _process_scraped_content(
    ...
    try:
        ...
        # Strategy: Scoped Cleaning
        # Instead of cleaning the entire document (slow), find the content first,
        # then clean only that subtree.
        ...
        for selector in CONTENT_SELECTORS:
            try:
                ...
                if candidate:
                    ...
                    # Check "clean" length
                    clean_text = candidate.get_text(separator=" ", strip=True)
